...
<div id="container">
	<div id="header"><a href="../php/logout.php">注销</a><?php echo "Role: ".$role." User ID :".$user_id  ?></div>
		...
		<div class="grid">
			<div class="title">
			 <img src="../web_image/forum.png" height="25px" />在线论坛
			 </div>
			 
			 <input type="button" class="button" value="发帖子" onclick="showPanel('forumPanel')"/>
			 <div id="forumPanel" style="display:none;">
			 <p><b>新帖子</b></p>
			 <form method="post" action="../php/addForum.php?action=add">
			 <table width="400" border="0.5">
			  ...
			  <tr>
				<td>内容</td>
				<td><textarea cols="45" rows="5" name="content"></textarea></td>
			  </tr>
			</table>
			<p align="center"><input type="submit" class="button" value="确定"/><input type="reset" class="button" value="清空" /></p>
			</form>
			 </div>
			 <div>
			<table width="580" border="0.5">
				<thead>
				<tr height="30">
					<th width="100">发帖人</th>
					<th width="270">题目</th>
					<th width="180">最近回复时间</th>
					<th width="80">回帖数</th>
				</tr>
				</thead>
				<tbody bgcolor="#D5E1FD">
				<?php 
				$sql1 = "select * from user,forum where user.user_id=forum.author_id";
				$result1 = mysql_query($sql1);
				while($row1 = mysql_fetch_array($result1)){
				?>
				<tr>
					<td align="center"><?php echo $row1['user_name']?></td>
					<td><a href="forum_detail.php?id=<?php echo $row1['forum_id']?>" target="_blank"><?php echo $row1['title']?></a></td>
					<td align="center"><?php echo $row1['edit_time']?></td>
					<td align="center"><?php echo $row1['reply_num']?></td>
			  	</tr>
				<?php
				}
				?>
