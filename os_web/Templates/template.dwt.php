...
<div id="container">
	<div id="header"><a href="../php/logout.php">注销</a><?php echo "Role: ".$role." User ID :".$user_id  ?></div>
		...
		<div class="navigationBox">
			...
			<div class="navigation"><a href="../html/home.php">我的班级</a></div>
			<div class="navigation"><a href="../html/test.php">测试记录</a></div>
			<div class="navigation"><a href="../html/forum.php">论坛</a></div>
		</div>
		...
		<div id="left">
			...
			<p align="center">
			<input type="button" id="showbtn" name="showbtn" onclick="showPanel('infoPanel');" value="编辑" /></p>
			...
			<div class="line">
			  ...
			  <tr>
				<td></td>
				<td><input type="submit" name="updateInfo" value="保存新密码" onclick="return checkForm1()"/></td>
			  </tr>
			  </form>
			  <tr>
			  <form name="updateAvatar" action="../php/update.php?action=updateAvatar" method="post" enctype="multipart/form-data" ><!-- 一定要写enctype="multipart/form-data"这个，否则传不了file name-->
				...
				<input type="submit" value="更新头像" name="updateAvatar" onclick="return checkForm2();">
				</td>
				</form>
